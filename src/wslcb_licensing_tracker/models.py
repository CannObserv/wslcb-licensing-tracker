...
locations = Table(
    ...
    Column("std_country", Text, nullable=False, server_default="''"),
...
license_records = Table(
    ...
    Column("previous_business_name", Text, nullable=False, server_default="''"),
    Column("previous_applicants", Text, nullable=False, server_default="''"),
...
admin_users = Table(
    ...
    # Case-insensitive uniqueness lives in a functional unique index on
    # lower(email), defined in the Alembic baseline migration DDL — SQLAlchemy
    # Core cannot express functional constraints inline on Table objects.
...
regulated_substances = Table(
    ...
    # Case-insensitive uniqueness lives in a functional unique index on
    # lower(name), defined in the Alembic baseline migration DDL.
