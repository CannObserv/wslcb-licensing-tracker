...
PENDING_CUTOFF_DAYS) and outcome_filter_sql() shared by link_records
and the queries_* modules.
"""
...
# ---------------------------------------------------------------------------
# Application pipeline constants (shared by link_records, queries_*)
# ---------------------------------------------------------------------------
