...
RECORD_COLUMNS = """
    ...
    COALESCE(loc.std_address_line_1, '') AS address_line_1,
    COALESCE(loc.std_address_line_2, '') AS address_line_2,
    ...
    COALESCE(ploc.std_address_line_1, '') AS prev_address_line_1,
    COALESCE(ploc.std_address_line_2, '') AS prev_address_line_2,
