"""Tests for the async PostgreSQL ingestion pipeline (pipeline.py).
...
from wslcb_licensing_tracker.pipeline import (
    IngestOptions,
    ingest_batch,
    ingest_record,
    insert_record,
...
class TestPgIngestRecord:
    ...
    async def test_enrichment_failure_isolation(
        ...
        monkeypatch.setattr("wslcb_licensing_tracker.pipeline.process_record", _boom)
